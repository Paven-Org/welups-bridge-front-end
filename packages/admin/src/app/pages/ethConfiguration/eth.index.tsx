...
import WelAccModal from "./eth.modal";
import { styles } from "./eth.style";
...
import EthPrikeyModal from "./eth.prikey.modal";

const EthConfig: React.FC = () => {
  ...
  const { mutateAsync: deleteAsync } = useAccountDelete();
  const { mutateAsync: mutateAccountStatus } = useMutateAccountStatus();
