...
import WelConfig from "../welConfiguration/wel.index";
import EthConfig from "../ethConfiguration/eth.index";
    ...
    <Box sx={styles.homeContainer}>
      ...
      >
        ...
        >
          ...
          <Tab label="WELUPS Configuration" />
          <Tab label="ETH Configuration" />
        </Tabs>
      </Box>
